...
import NewDepartementModal from "./components/NewDepartementModal";
import { departements_routes_items } from "@/routes/gestion_facultes/departements/departements_routes";
...
export default function DepartementList() {
  ...
  const deleteItems = async (itemsIds) => {
    try {
      ...
      form.append("IDS_DEPARTEMENT", JSON.stringify(Array.isArray(itemsIds) ? itemsIds : [itemsIds.ID_DEPARTEMENT]));
  ...
  useEffect(() => {
    ...
    setBreadCrumbAction([departements_routes_items.departements])
    document.title = departements_routes_items.departements.name;
  ...
  return (
    <>
      ...
      {addVisible && <NewDepartementModal visible={addVisible} setVisible={setAddVisible} data={inViewMenuItem} fetchDepartements={fetchDepartements} />}

      <div className="px-4 py-3 main_content">
        <div className="d-flex align-items-center justify-content-between">
          <h1 className="mb-3">Departements</h1>
          <Button
            label="Nouveau"
