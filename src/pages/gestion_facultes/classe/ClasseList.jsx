...
import { classes_routes_items } from "@/routes/gestion_facultes/classes/classes_routes";
import NewClasseModal from "./components/NewClasseModal";
...
export default function ClasseList() {
  ...
  const deleteItems = async (itemsIds) => {
    try {
      ...
      form.append("IDS_CLASSE", JSON.stringify(Array.isArray(itemsIds) ? itemsIds : [itemsIds.ID_CLASSE]));
  ...
  useEffect(() => {
    ...
    setBreadCrumbAction([classes_routes_items.classes])
    document.title = classes_routes_items.classes.name;
  ...
  return (
    <>
      ...
      {addVisible && <NewClasseModal visible={addVisible} setVisible={setAddVisible} data={inViewMenuItem} fetchClasses={fetchClasses} />}
        ...
        <div className="content">
          <div className="shadow rounded mt-3 pr-1 bg-white">
            <DataTable
              ...
              emptyMessage="Aucune classe trouvé"
