                    ...
                    <Panel header="Identification" toggleable>
                        ...
                        <div className="form-group col-sm mt-5">
                            <div className="row">
                                ...
                                <div className="col-4">
                                    <div>
                                        <label htmlFor="TELEPHONE" className="label mb-1">Numére téléphone
                                            <span style={{ color: 'red', fontSize: 18 }}>*</span>
                                        </label>
                                    </div>

                                    <InputText type="text" placeholder="Ecrire votre numéro tél" id="TELEPHONE" name="TELEPHONE" value={data.TELEPHONE} onChange={e => setData(d => ({ ...d, TELEPHONE: e.target.value }))} className={`w-100 is-invalid ${errors?.TELEPHONE ? 'p-invalid' : ''}`} />
                                ...
                                <div className="col-4">
                                    ...
                                    <div>
                                        <Dropdown
                                            id="sexe"
                                            name="sexe"
                                            value={sexes.find(s => s.SEXE_ID === data.SEXE_ID) || null}
                                            onChange={(e) => setData(d => ({ ...d, SEXE_ID: e.value.SEXE_ID }))}
                                            options={sexes}
