...
import NewMotifModal from "./components/NewMotifModal";
import { motifs_routes_items } from "@/routes/gestion_motifs/motifs_routes";
...
export default function MotifList() {
  ...
  const deleteItems = async (itemsIds) => {
    try {
      ...
      form.append("IDS_MOTIF", JSON.stringify(Array.isArray(itemsIds) ? itemsIds : [itemsIds.ID_MOTIF]));
  ...
  useEffect(() => {
    ...
    setBreadCrumbAction([motifs_routes_items.motifs])
    document.title = motifs_routes_items.motifs.name;
  ...
  return (
    <>
      ...
      {addVisible && <NewMotifModal visible={addVisible} setVisible={setAddVisible} data={inViewMenuItem} fetchMotifs={fetchMotifs} />}
          ...
          <div className="selection-actions d-flex align-items-center">
            ...
            <a
              ...
              onClick={(e) =>
                handleDeletePress(
                  e,
                  selectedItems.map((item) => item.ID_MOTIF)
                )
              }
            >
              <svg
        ...
        <div className="content">
          <div className="shadow rounded mt-3 pr-1 bg-white">
            <DataTable
              ...
              emptyMessage="Aucun motif trouvé"
